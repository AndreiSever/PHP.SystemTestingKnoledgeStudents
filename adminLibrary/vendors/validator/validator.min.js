...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : '<p>пожалуйста заполните поле',
    ...
    */
    tests = {
        ...
        linked : function(a,b){
            if( (b != a) ){
                // choose a specific message or a general one ||(b!=="" && a=="") ||(b=="" && a!=="")
        ...
        email : function(a){
            if ( !email_filter.test( a ) && (a !== ""))  {   ////!email_filter.test( a ) || || a.match( email_illegalChars )
                alertTxt = a ? message.email : "";
                return false;
            }
            return true;
        },
