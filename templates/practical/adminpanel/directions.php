                      ...
                      <li><a class="collapse-linkEdit"><i class="fa fa-chevron-down"></i></a>
						...
						<div class="x_contentEdit" style="display: none;">
							<div class="form-inline">
								...
								<button class="btn btn-primary" onclick="addRowDirect('datatable1', '<?php  echo '/adminpanel/directions_sql/'; ?>','/adminpanel/sub_themes/');return false;">Добавить</button>
								<button type="button" class="btn btn-default" onclick="deleteRowDirect('datatable1','<?php  echo '/adminpanel/directions_sql/'; ?>');return false;">Удалить</button>	
							</div>
						</div>
					</div>
					<br/>
                   ...
                   <table id="datatable1" class="table table-striped table-bordered jambo_table bulk_action">
                      <thead>
                        <tr>
                          ...
                          <th class="thStyleForListDirections">Темы</th>
					...
					if (mysqli_num_rows ($result) !== 0){
						...
						echo    '<tr class="even pointer">
									  ...
									  <td >
										<span class="" style="display: inline;"><a href="/adminpanel/sub_themes/'.$group['id'].'">Посмотреть темы</a></span>
									  </td>
						...
						?>
									  <td ><button class="btn btn-success" onclick="saveStyleForDirect(this,'/adminpanel/directions_sql/');return false;" disabled><span class="glyphicon glyphicon-ok"></span> </button></td>
								</tr>
						<?php	}
                        }else{
